...
test_df = pd.read_csv(r"C:\Users\D. Naga sujith kumar\Desktop\Capstone\Skin Disease Dataset V2.v2i.multiclass\test")

# Define the test data generator
test_generator = CustomDataGenerator(test_df, test_img_dir, BATCH_SIZE, IMG_SIZE)

# Load the trained model
model = load_model(r"C:\Users\D. Naga sujith kumar\Desktop\Capstone\final_trained_model_resnet.keras")
